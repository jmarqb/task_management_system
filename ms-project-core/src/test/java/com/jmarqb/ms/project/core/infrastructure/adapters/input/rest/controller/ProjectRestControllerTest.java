...
class ProjectRestControllerTest {
    ...
    void createThrowsHttpMessageNotReadableException() throws Exception {
        ...
        CreateProjectDto createDto = Instancio.of(CreateProjectDto.class)
                ...
                .set(field(CreateProjectDto::getOwnerId), null)
                .create();
        Project projectNew = projectMapper.toDomain(createDto);

        when(projectUseCase.save(projectNew)).thenThrow(new HttpMessageNotReadableException("Cannot deserialize value for Json", null, null));
    ...
    @Test
    void handleProjectThrowUnauthorized_withMockMvc() {
